...
class Config():
    training_dir = "/data_disk/ds_ro/amuresan/nanonets_object_tracking/nvidia_city_challenge/crops"
    testing_dir = "/data_disk/ds_ro/amuresan/nanonets_object_tracking/nvidia_city_challenge/crops_test"
...
net = torch.load('ckpts/model80.pt').cuda()
net.eval()
