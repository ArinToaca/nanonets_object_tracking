...
class STrack(BaseTrack):
    ...
    def __init__(self, tlwh, score, temp_feat, buffer_size=30, counter_provider=None):
    ...
    def activate(self, kalman_filter, frame_id):
        ...
        self.track_id = self.counter_provider.increment_and_get()
...
class JDETracker(object):
    def __init__(self, opt, frame_rate=30, counter_provider=None):
        self.opt = opt
        STrack._count = 0
    ...
    def update(self, pred):
        ...
        if len(pred) > 0:
            ...
            # dets = non_max_suppression(pred, self.opt.conf_thres, self.opt.nms_thres)[0]
            ...
            for det in pred:
                ...
                strack = STrack(det[:4], det[4], feat, 30, self.counter_provider)
